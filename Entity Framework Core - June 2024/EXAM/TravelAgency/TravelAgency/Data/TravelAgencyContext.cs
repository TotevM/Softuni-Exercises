...
namespace TravelAgency.Data
{
    ...
    {
        private const string connectionString = @"Server=DESKTOP-VHFETI7\SQLEXPRESS;Database=TravelAgency;Integrated Security=True";
        ...
        {
            modelBuilder.Entity<TourPackageGuide>().HasKey(x => new { x.TourPackageId, x.GuideId });
